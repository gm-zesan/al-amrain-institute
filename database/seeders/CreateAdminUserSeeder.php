...
class CreateAdminUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin = User::create([
            ...
            'email' => 'info@alamraininstitute.com',
            'password' => bcrypt('Alamrain01'),
        ...
        //     array('id' => '5','name' => 'Dev Test','email' => 'devtest@gmail.com','phone_no' => '7868304071','email_verified_at' => NULL,'password' => '$2y$12$OYQmPop8UhaihAIAu9U/GeDeEM/ojp4CgAWJXj3gP8RND9IuC3WH6','image' => 'all-users/TiWrm02xx1ISPqnSlph6R6dtCMNdAvbRegkvtTDp.png','address' => 'Rupgonj','is_blocked' => '0','is_certificate_enable' => '0','remember_token' => NULL,'created_at' => '2024-12-08 08:46:25','updated_at' => '2024-12-08 08:46:25'),
        ...
        // $teachers = array(
        //     array('id' => '7','name' => 'Teacher 1','email' => 'teacher1@gmail.com','phone_no' => '01932456792','email_verified_at' => NULL,'password' => '$2y$12$weYs3Da2WBZsGiMEMocNGeIVP9iw5.PjHdrvjKusZ8uLIXRl3z5ey','image' => 'all-students/6JVIPfs7iyCxXXstJNEpEznT7PVxu4AZkUvNkO3t.jpg','address' => NULL,'details' => '<p><strong>choolteacher or formally an educator</strong>, is a person who helps students to acquire knowledge, competence, or virtue, via the practice of teaching.</p>','is_blocked' => '0','is_certificate_enable' => '0','remember_token' => NULL,'created_at' => '2024-12-24 11:56:47','updated_at' => '2024-12-24 12:27:48'),
