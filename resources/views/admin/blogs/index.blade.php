                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            ...
                            btn1 += '<a href="' + SITEURL + '/dashboard/blog/edit/' + data + '"title="edit" class="btn btn-edit"><i class="ri-edit-line"></i></a>';
                            btn1 += '<a href="' + SITEURL + '/dashboard/blog/delete/' + data + '" title="delete" class="btn btn-delete"><i class="ri-delete-bin-2-line"></i></a>';
