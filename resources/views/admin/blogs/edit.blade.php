            ...
            <div class="col-md-4 col-12">
                <div class="row g-4">
                        ...
                        <div class="card table-card">
                            ...
                            <div class="custom-form card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="{{route('blogs')}}" class="btn leave-button">Leave</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card table-card">
                            <div class="table-header">
                                <div class="table-title">Blog Image</div>
                            </div>
                            <div class="custom-form card-body">
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $blog->image ? asset('storage/' . $blog->image) : asset('images/admin/default.jpg') }}" alt="background-image" class="image-preview">
