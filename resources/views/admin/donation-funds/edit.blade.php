...
<div class="container-fluid my-3">
    <form action="{{ route('donation-fund.update', ['id' => $donation->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-4">
                ...
                <div class="card table-card">
                    <div class="card-header table-header">
                        <div class="title-with-breadcrumb">
                            <div class="table-title">Donation Fund</div>
                            <nav aria-label="breadcrumb"> 
                                <ol class="breadcrumb mb-0"> 
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="{{route('donation-funds')}}">Donation Fund</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"> Edit Donation Fund</li>
                                </ol>
                            </nav>
                        </div>
                        <a href="{{route('donation-funds')}}" class="add-new">Donation Fund<i class="ms-1 ri-list-ordered-2"></i></a>
                    </div>
                    <div class="card-body custom-form">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control custom-input" name="name" value="{{$donation->name}}">
                                @if($errors->has('name'))
                                    <div class="error_msg">
                                        {{ $errors->first('name') }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control custom-input" name="description" id="description" rows="5"  placeholder="Description"  style="resize: none; height: auto">{{$donation->description}}</textarea>
            ...
            <div class="col-md-4 col-12">
                <div class="row g-4">
                        ...
                        <div class="card table-card">
                            ...
                            <div class="custom-form card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <a href="{{route('donation-funds')}}" class="btn leave-button">Leave</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="card table-card">
                            <div class="table-header">
                                <div class="table-title">Donation Fund Image</div>
                            </div>
                            <div class="custom-form card-body">
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $donation->image ? asset('storage/' . $donation->image) : asset('images/admin/default.jpg') }}" alt="background-image" class="image-preview">
