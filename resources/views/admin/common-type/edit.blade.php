...
<div class="container-fluid my-3">
    <form action="{{ route('commontype.update', ['id' => $commontype->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row g-4">
                ...
                <div class="card table-card">
                        ...
                        <div class="title-with-breadcrumb">
                            ...
                            <nav aria-label="breadcrumb"> 
                                <ol class="breadcrumb mb-0"> 
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Edit Common type</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="card-body custom-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input type="hidden" class="form-control custom-input" name="name" value="{{$commontype->name}}">
                                @if($errors->has('name'))
                                    <div class="error_msg">
                                        {{ $errors->first('name') }}
                                    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control custom-input" name="description" id="description" rows="5"  placeholder="Description"  style="resize: none; height: auto">{{$commontype->description}}</textarea>
                                ...
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $commontype->image ? asset($commontype->image) : asset('images/admin/default.jpg') }}" alt="background-image" class="image-preview">
