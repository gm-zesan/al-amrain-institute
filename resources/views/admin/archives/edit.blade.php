                        ...
                        <div class="title-with-breadcrumb">
                            ...
                            <nav aria-label="breadcrumb"> 
                                <ol class="breadcrumb mb-0"> 
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"> Edit Archive</li>
                                </ol>
                            </nav>
                        </div>
                                ...
                                <div class="image-select-file">
                                    <label class="form-label custom-label" for="cover_image">
                                        ...
                                        <div class="user-image">
                                            <img id="cover_imagePreview" src="{{ $archive->image ? asset('storage/' . $archive->image) : asset('images/admin/default.jpg') }}" alt="background-image" class="image-preview">
