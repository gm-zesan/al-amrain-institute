                    ...
                    <div class="card-body custom-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control custom-input" name="phone" placeholder="Phone">
                                @if($errors->has('phone'))
                                    <div class="error_msg">
                                        {{ $errors->first('phone') }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                <label for="linkedin" class="form-label custom-label">LinkedIn</label>
                                <input type="text" class="form-control custom-input" name="linkedin" placeholder="LinkedIn">
